...
public class PastTransac extends AppCompatActivity {
    ...
    String URL= "http://192.168.1.101/Android_Login/getusertransaction.php";
            ...
            try{
                if(!jArray.getJSONObject(0).getString("result").equals("empty")) {
                    ...
                    for (int i = 0; i < jArray.length(); i++) {
                        ...
                        TextView ts1 = new TextView(PastTransac.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            case R.id.logout:
                ...
                editor.clear();
                editor.commit();
                PastTransac.EditToken getCompany= new PastTransac.EditToken();
